<x-layouts.app>
    ...
    <x-slot name="meta">
        ...
        >
        <meta property="og:image" content="{{ asset('images/nagender.jpg') }}">
        ...
        <div class="w-full bg-white max-w-3xl py-16 mx-auto">
            <div class="header-card relative">
                ...
                <div class="absolute -bottom-16 left-0 right-0 flex items-center justify-center">
                    <img src="{{ asset('images/nagender.jpg') }}" alt="" class="h-40 w-40 rounded-3xl object-cover border-4 border-white">
                </div>
            </div>
